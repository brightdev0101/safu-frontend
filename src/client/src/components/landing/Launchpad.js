    ...
    validateField(fieldName, value) {
        ...
        switch(fieldName) {
            ...
            case 'listingRate':
                ...
                break;
            case 'from':
                fromValid = !isEmpty(value) ? '' : ' is invalid';
                fieldValidationErrors.from = fromValid ? '' : ' is invalid';
                break;
            case 'to':
                toValid = !isEmpty(value) ? '' : ' is invalid';
                fieldValidationErrors.to = toValid ? '' : ' is invalid';
                break;
            case 'router':
                routerValid = !isEmpty(value) ? '' : ' is invalid';
                fieldValidationErrors.router = routerValid ? '' : ' is invalid';
                break;
                        ...
                        <div className="py-6 container">
                            ...
                            <div className="ant-card ant-card-bordered">
                                <div className="ant-card-body">
                                    <h1 className="display-4 text-center">Launchpad Info</h1>
                                    ...
                                    <form>
                                        ...
                                        <div className="field"><label htmlFor="" className="label">Whitelist</label>
                                            <div className="ant-radio-group ant-radio-group-outline">
                                                <div className="ant-space ant-space-horizontal ant-space-align-center" style={{gap: '8px'}}>
                                                    <div className="ant-space-item"><label className="ant-radio-wrapper ant-radio-wrapper-checked"><span className="ant-radio ant-radio-checked"><input type="radio" className="ant-radio-input" value="false" /><span className="ant-radio-inner"></span></span><span>Disable</span></label></div>
                                                    <div className="ant-space-item"><label className="ant-radio-wrapper"><span className="ant-radio"><input type="radio" className="ant-radio-input" value="true" /><span className="ant-radio-inner"></span></span><span>Enable</span></label></div>
                                                </div>
                                            </div>
                                        ...
                                        <div className="has-text-centered">
                                            <div className="has-text-info p-4">Need 0 www to create launchpad.</div><Link to="/1verify" className="btn btn-secondary"><span>Back</span></Link><span className="mr-4"></span><Link to={this.state.formValid?'/3addInfo':'#'} className="btn btn-primary"><span>Next</span></Link>
                                        </div>
                                    </form>
                                </div>
                            </div>
