    ...
    <div className="py-6 container">
        ...
        <div className="bg-dark style-border ant-card ant-card-bordered" style={{marginBottom:'100px'}}>
            <div className="ant-card-body">
                ...
                <div className="has-text-centered" ><a href="/LaunchPad1" className="btn btn-success"><span>Launch Now</span></a></div>
        ...
        <div className="row">
          <div className=" bg-dark style-border ant-card ant-card-bordered" style={{marginBottom:'30px'}}>
              <div className="ant-card-body">
                  ...
                  <div className="has-text-centered" ><a href="/CreateToken" className="btn btn-success"><span>Create Now</span></a></div>
              </div>
          </div>
          <div className="bg-dark style-border ant-card ant-card-bordered" style={{marginBottom:'30px'}}>
              <div className="ant-card-body">
