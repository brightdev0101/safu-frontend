                                                    ...
                                                    <div className="content">
                                                        <div className="is-flex is-align-items-center">
                                                            <div className="is-flex-grow-1 is-flex is-align-items-center single-title">
                                                                <h1 className="title mr-2">3w Presale</h1>
                                            ...
                                            <div className="table-container mt-6">
                                                <table>
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td>Token Name</td>
                                                            <td className="has-text-right">{window.localStorage.getItem("title")}</td>
                                                        </tr>
                                                        <tr>
                                                            <td>Token Symbol</td>
                                                            <td className="has-text-right">{window.localStorage.getItem("symbol")}</td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            <td>Presale Rate</td>
                                                            <td className="has-text-right">1 BNB = {window.localStorage.getItem("rate")}{window.localStorage.getItem("symbol")}</td>
                                                        </tr>
                                                        {/* <tr>
                                                            <td>Listing Rate</td>
                                                        ...
                                                        <tr>
                                                            <td>Soft Cap</td>
                                                            <td className="has-text-right">{window.localStorage.getItem("softCap")}</td>
                                                        </tr>
                                                        <tr>
                                                            <td>Hard Cap</td>
                                                            <td className="has-text-right">{window.localStorage.getItem("hardCap")}</td>
                                                        </tr>
                                                        <tr>
                                                            <td>Minimum Buy</td>
                                                            <td className="has-text-right">{window.localStorage.getItem("minBuy")}</td>
                                                        </tr>
                                                        <tr>
                                                            <td>Maximum Buy</td>
                                                            <td className="has-text-right">{window.localStorage.getItem("maxBuy")}</td>
                                                        </tr>
                                                        {/* <tr>
                                                            <td>Unsold Tokens</td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td className="has-text-right">{window.localStorage.getItem("from")}</td>
                                                        </tr>
                                                        <tr>
                                                            <td>Presale End Time</td>
                                                            <td className="has-text-right">{window.localStorage.getItem("to")}</td>
                                                        </tr>
                                                        {/* <tr>
                                                            <td>Listing On</td>
